...
open class CustomSegment: View, EventTrigger {
    ...
    public init(titles: [String], bgHeight: CGFloat, bgColor: UIColor = UIColor.hex(0xffffff), bgCornerRadious: CGFloat? = nil, selectedTextColor: UIColor? = Colors.headline, normalTextColor: UIColor = UIColor.hex(0x737780), font: UIFont = Fonts.auto(14)) {
        self.titles = titles
