...
open class SSDefaultTableViewCell: SSTableViewCell {
    public var containerHeightConstraint: Constraint!
    public lazy var containerStackView: SSHorizontalStackView = {
        let view = SSHorizontalStackView()
        view.spacing = 10
        return view
    }()
    
    public lazy var leftStackView: SSHorizontalStackView = {
        let view = SSHorizontalStackView()
    ...
    public lazy var rightStackView: SSHorizontalStackView = {
        let view = SSHorizontalStackView()
...
//    private var hasArrowImageV: Bool = false
    ...
    public lazy var defaultTitleLab: UILabel = {
        let label = UILabel.makeLabel(textColor: SSColors.headline,
                                      font: SSFonts.medium(14))
        return label
    }()
    
    public lazy var defaultRightLabel: UILabel = {
        let label = UILabel.makeLabel(textColor: SSColors.detailText,
                                      font: SSFonts.medium(14),
                                      alignment: .right)
        return label
    }()
    ...
    open override func bind(_ cellViewModel: SSCellViewModel) {
