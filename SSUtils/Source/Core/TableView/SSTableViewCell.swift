...
open class SSTableViewCell: UITableViewCell {
    public var disposeBag = DisposeBag()
    
    public lazy var lineView: UIView = {
        let lineView = UIView()
        lineView.backgroundColor = SSColors.line
        return lineView
    }()
    ...
    open var lineHeight: CGFloat = SSApp.pixel
    ...
    open func make() {
        backgroundColor = SSColors.contentBackgroud
        lineView = UIView()
        lineView.backgroundColor = SSColors.line
...
public extension Reactive where Base: SSTableViewCell {
