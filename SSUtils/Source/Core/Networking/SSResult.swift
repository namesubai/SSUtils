...
public enum SSServiceErrorCode: Int {
    case unKnow = -11001
    case parseFailure = -11002
    case customError = -11003
...
public enum SSServiceError: Swift.Error {
        
    case serverError(response: SSRootResult)
    ...
    public var code: Int {
        ...
        case .parseResultError : return SSServiceErrorCode.parseFailure.rawValue
        case .customError(_) : return SSServiceErrorCode.customError.rawValue
        case .unownedError: return SSServiceErrorCode.unKnow.rawValue
        }
    }
}

public protocol SSRootResult: Mappable {
    var msg: String? { get }
    var code: Int { get }
