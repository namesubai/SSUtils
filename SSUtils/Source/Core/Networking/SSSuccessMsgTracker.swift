...
public class SSSuccessMsgTracker: NSObject,SharedSequenceConvertibleType {
    ...
    private func increment(_ result: SSRootResult?) {
        _lock.lock()
...
public extension ObservableConvertibleType where Element: MapResult {
    public func trackSuccessMsg(_ activityIndicator: SSSuccessMsgTracker, _ msg: String? = nil) -> Observable<Element> {
