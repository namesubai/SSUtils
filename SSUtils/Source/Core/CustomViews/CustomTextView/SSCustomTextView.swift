...
open class SSCustomTextView: SSView, SSEventTrigger {
    ...
    public lazy var textView: UITextView = {
        ...
        textView.font = SSFonts.medium( 15)
        textView.textColor = SSColors.subTitle
        return textView
    }()
...
extension SSCustomTextView: UITextViewDelegate {
