...
public extension Reactive where Base: ImagesView {
...
//                        let height = width * (result.1.height / result.1.width)
                        let width = ImagesView.singlePicMaxWidth
                        let height = ImagesView.singlePicMaxWidth
