...
private class CustomPageIndicator: SSButton {
    
}

open class SSCustomPageControl: SSView, SSEventTrigger {
    
    public enum Event {
        case selectPageNum(num: Int)
    }
    
    private lazy var containerStackView: SSHorizontalStackView = {
...
public extension Reactive where Base: SSCustomPageControl {
