...
extension SSBubblePopupView {
    public class Action {
        ...
        init(image: UIImage? = nil,
             ...
             titleFont: UIFont? = SSFonts.auto(14.wScale),
             space: CGFloat = 5,
...
public extension SSBubblePopupView {
    /// 三角形在视图的位置
...
open class SSBubblePopupView: UIView {
    /// 边框大小
    ...
    private lazy var containView: SSVerticalStackView = {
    ...
    func show(sourceView: UIView, sourceRect: CGRect? = nil, distance: CGFloat = 10.wScale, width: CGFloat = 100.wScale) {
        guard let window = SSApp.mainWindow else { return }
