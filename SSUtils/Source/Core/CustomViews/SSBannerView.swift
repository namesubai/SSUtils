...
public class SSBannerView: UIView, SSEventTrigger {
    ...
    lazy var pageControl: SSCustomPageControl = {
        let view = SSCustomPageControl()
...
extension SSBannerView: UICollectionViewDataSource, UICollectionViewDelegate {
