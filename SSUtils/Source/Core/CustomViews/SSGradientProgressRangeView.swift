//
//  SSGradientProgressRangeView.swift
//  SSUtils
//
...
open class SSGradientProgressRangeView: SSView, SSEventTrigger {
    public enum Event {
        case progressDidChange
        case beginSliderDrag
        case endSliderDrag
    }
    public var progressGradientColors: [CGColor] = SSColors.gradientColors {
        didSet {
    ...
    private lazy var normalView: SSGradientView = {
