...
public protocol SSViewModelType: NSObject {
...
public extension SSViewModelType {
...
open class SSViewModel: NSObject {
    
    public var page: Int = 1
    public var size: Int = 20
    public var msgToast = SSSuccessMsgTracker()
...
//    public var emptyError = ErrorTracker()
    ...
    public var noData = ReplaySubject<SSNoData?>.create(bufferSize: 1) /// 有预加载都情况，bindmodel后执行了
